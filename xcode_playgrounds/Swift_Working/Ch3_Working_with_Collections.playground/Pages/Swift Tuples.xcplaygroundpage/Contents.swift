 ...
 */
// Simple tuple
var charAttack: (String, Int, Bool) = ("BamBam", 5, true)
charAttack.0
charAttack.1
charAttack.2

var bamBam = charAttack.0
var bamBamValue = charAttack.1
var bamBamState = charAttack.2

var (attack, damage, rechargeable) = charAttack
attack
damage
rechargeable
