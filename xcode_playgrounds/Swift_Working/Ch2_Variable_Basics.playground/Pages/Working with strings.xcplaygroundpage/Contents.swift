...
var tammyString = "Tammy is writing a string. A STRING I tell you!"

// String data

tammyString.uppercased()
tammyString.removeLast()
tammyString.count
tammyString.contains("S")
tammyString.contains("z")
tammyString.removeAll()
